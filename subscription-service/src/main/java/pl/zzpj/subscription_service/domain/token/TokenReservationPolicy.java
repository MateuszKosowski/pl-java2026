...
public class TokenReservationPolicy {
    ...
    public TokenReservationPolicy(SubscriptionCatalog subscriptionCatalog, PricingCatalog pricingCatalog) {
    ...
    public TokenReservationPolicy(
        ...
        this.subscriptionCatalog = Objects.requireNonNull(subscriptionCatalog, "subscriptionCatalog must not be null");
    ...
    public TokenDecision decide(ActiveSubscription subscription, TokenBalance balance, TokenOperation operation, Instant now) {
        Objects.requireNonNull(subscription, "subscription must not be null");
        Objects.requireNonNull(balance, "balance must not be null");
        Objects.requireNonNull(operation, "operation must not be null");
        Objects.requireNonNull(now, "now must not be null");

        return subscriptionCatalog.findPlan(subscription.planCode())
    ...
    private TokenDecision decideForPlan(
        ...
        if (!balance.canReserve(cost)) {
            return new RejectedInsufficientTokens(
                    operation,
                    cost,
        ...
        return new Accepted(new TokenReservation(
                UUID.randomUUID(),
                subscription.userId(),
                operation,
                cost,
