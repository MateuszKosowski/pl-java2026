package pl.zzpj.eureka_server.architecture;
...
/**
 * ArchUnit architecture rules scoped to the eureka-server base package.
 * eureka-server is an infrastructure module with no controller/service/repository
 * layers, so most rules match nothing; allowEmptyShould(true) keeps them green.
 */
class ArchitectureTest {

    private static final String BASE_PACKAGE = "pl.zzpj.eureka_server";
