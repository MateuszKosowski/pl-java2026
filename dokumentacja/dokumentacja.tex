...
\begin{itemize}
    ...
    \item \textbf{Serwis znakowania (watermarkingu)} oparty o zaawansowany silnik w języku Python osadzający zaszyfrowane komunikaty w dziedzinie częstotliwościowej (transformata DWT-DCT-SVD) obrazów PNG.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{use_cases.pdf}
...
7. \texttt{ai-service} uruchamia model ONNX, klasyfikuje obraz i zwraca etykiety (np. klasyfikacja: "pies", pewność: 34\%). \newline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{seq_embed_ai.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{seq_subscription_upgrade.pdf}
